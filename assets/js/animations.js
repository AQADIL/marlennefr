...
const I18N = {
    en: {
        'page.title': 'Marlen Meirbek — legendary nefr from Satbayev',
        'nav.home': 'Home',
        'nav.about': 'About',
        'nav.skills': 'Skills',
        'nav.contact': 'Contact',
        ...
        'hero.nickname': 'nefr from Satbayev',
        'about.title': 'About me',
        'about.subtitle': 'Not a senior. Just a nefr.',
        'about.p1': 'I\'m not a 10x rockstar ninja dev. I\'m just a Satbayev "nefr" guy who fell in love with glowing pixels, bad CSS and Three.js diamonds that spin a bit too much.',
        ...
        'about.stats.impostor': '% Impostor energy',
        ...
        'contact.subtitle': 'Want to ping the nefr?',
    ...
    kz: {
        'page.title': 'Марлен Мейірбек — Сәтбаевтағы нефр',
        'nav.home': 'Басты бет',
        'nav.about': 'Мен туралы',
        'nav.skills': 'Скилл мәселелері',
        'nav.contact': 'Байланыс',
        'hero.subtitle': 'Интернеттегі өз кішкентай бұрышыма қош келдің',
        'hero.description': 'Мен Марлен Мейірбек – Сәтбаевтағы нефр-бала. Әлі күнге дейін "div-ті қалай ортасына қою" деп гуглдап жүрсем де, сонымен қатар әдемі цифрлық вайбтар құрып жүрмін. Мұнда аздап хаос, мемдер және жарқыраған 3D гауһар бар.',
        'hero.name': 'Марлен Мейірбек',
        'hero.btn.primary': 'Рөлді бұра',
        'hero.btn.secondary': 'Байланысқа шығу',
        'hero.nickname': 'Сәтбаевтағы нефр',
        'about.title': 'Мен туралы',
        'about.subtitle': 'Senior емеспін. Жәй ғана нефр-бала.',
        'about.p1': 'Мен 10x супер-программист емеспін. Сәтбаевта оқитын, жарқыраған пиксельдерге, сынды CSS-ке және шамадан тыс айналатын Three.js гауһарларға ғашық нефрмін.',
        ...
        'about.stats.impostor': '% Импостер-синдром энергиясы',
        ...
        'contact.subtitle': 'Нефрға жазғың келе ме?',
